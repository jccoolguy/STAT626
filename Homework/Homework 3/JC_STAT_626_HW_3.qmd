...
So, the true distribution of $e_i$ is $N(\sum_{l=1}^{i-1}y_l-\beta_0-\beta_1x_i,\sigma^2_w)$ which shows that the distribution of $e_i$ changes as $i$ changes, violating the assumption of i.i.d errors.
